    ...
    FLIGHT_PHASES: {
      ...
      STARTING_ENGINES: {
        ...
        items: {
          ...
          // Right column
          EICAS_UPPER_MFD_1: { id: "starting_engines_eicas_upper_mfd_1", title: "EICAS (Upper MFD Window)", value: "CHECK" },
      ...
      GO_AROUND: {
        ...
        items: {
          ...
          FLAPS_15: { id: "go_around_flaps_15", title: "Flaps", value: "15 DEG" },
